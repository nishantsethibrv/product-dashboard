...
const Dropdown = ({ label, name, options, selectedValue, onChange }) => {
  ...
  return (
    <div className="form-group">
      ...
      <select id={name} name={name} value={selectedValue} onChange={handleChange}>
